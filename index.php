...
$theLostCity = new Movie(
    ...
    "Azione, Avventura, Commedia, Romantico",
    "2022"
);
...
$sonic2 = new Movie(
    ...
    "Azione, Fantascienza, Commedia, Famiglia, Avventura",
    "2022"
);

$theNorthman = new Movie(
    4,
    "The Northman",
    ...
    "Azione, Avventura, Fantasy, Thriller",
    "2022"
);
...
var_dump($morbius, $theLostCity, $sonic2, $theNorthman, $uncharted, $batman)
?>
